...
eq('getCriterionByDroidId branch_protection has null piId', getCriterionByDroidId('branch_protection')?.piId, null);
...
eq('branch_protection is agent-only', agentOnlyIds.includes('branch_protection'), true);
eq('fast_ci_feedback is agent-only', agentOnlyIds.includes('fast_ci_feedback'), true);
