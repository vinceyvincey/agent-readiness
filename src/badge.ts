...
const LEVEL_LABEL: Record<string, string> = { L0: 'L0/unknown', L1: 'L1/functional', L2: 'L2/documented', L3: 'L3/standardized', L4: 'L4/optimized', L5: 'L5/autonomous' };
const LEVEL_COLOR: Record<string, string> = { L0: 'lightgrey', L1: 'red', L2: 'orange', L3: 'yellow', L4: 'blue', L5: 'brightgreen' };
