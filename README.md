...
- test/ - 9 test suites (engine, history, checks, deepening, monorepo, fix, criteria-registry, side-by-side, runtime-checks) — 254 assertions, all ALL PASS
